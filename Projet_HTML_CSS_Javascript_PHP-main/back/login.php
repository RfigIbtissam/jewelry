    ...
    <body>
		...
		<?php
			function redirectToProductsPage(){
				header("Location: http://localhost/Projet_HTML_CSS_Javascript_PHP-main/html/products.html");
			}
			$host = 'localhost';
			$dbname = 'tp_web';
			$username = 'root';
			...
			if(isset($_POST['select'])){
				...
				?>
					<div class="form">
						...
						<br><br>
						<a href="http://localhost/Projet_HTML_CSS_Javascript_PHP-main/html/products.html" class="btn" >Continuez sur notre site</a>
