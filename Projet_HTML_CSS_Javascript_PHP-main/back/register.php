		...
		if(isset($_POST['insert'])){
			...
			?>
				<div class="form">
					...
					<br><br>
					<a href="http://localhost/Projet_HTML_CSS_Javascript_PHP-main/index.php" class="btn" >Accueil</a>
					<a href="#" class="btn btnMenu" onclick="window.location='http://localhost/Projet_HTML_CSS_Javascript_PHP-main/html/login.html'">Se connecter sur le site</a>
